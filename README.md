...
2. `CamLock refiner`가 현재 RGB, raw mask, 이전 belief, motion 정보를 함께 보고 mask를 보정한다.
...
| lock 전 | `0.55 * net + 0.25 * raw + 0.20 * blurred_prev` |
...
실제 training log에서는 epoch 2에서 가장 낮은 validation loss를 기록했기 때문에, best checkpoint는 epoch 2이다.

```text
epoch 1: val_loss 0.6298907273419344
epoch 2: val_loss 0.6156377054656007
epoch 3: val_loss 0.6386667377060387
epoch 4: val_loss 0.6264448719466947
epoch 5: val_loss 0.6574616338464485
```
...
| ZoomNeXt-CamLock | 3742 | 0.460146 | 0.543594 | 0.600277 | 0.557405 | 0.384554 | 0.246371 |
...
| onset 전 | ZoomNeXt-CamLock | 1248 | 0.341311 | 0.405084 | 0.394161 | 0.568910 | 0.196950 |
| onset 후 | ZoomNeXt_Baseline | 2494 | 0.432353 | 0.503311 | 0.468564 | 0.429431 | 0.249879 |
| onset 후 | ZoomNeXt-CamLock | 2494 | 0.519611 | 0.612904 | 0.639092 | 0.292302 | 0.271102 |

onset 전에도 IoU가 `+0.039250`, Recall이 `+0.069986` 개선되지만, onset 이후에는 개선 폭이 훨씬 커진다.

| 구간 | IoU 개선 | Dice 개선 | Recall 개선 | Failure 감소 |
|---|---:|---:|---:|---:|
| onset 전 | `+0.039250` | `+0.051654` | `+0.069986` | `-0.049679` |
| onset 후 | `+0.087257` | `+0.109593` | `+0.170528` | `-0.137129` |
